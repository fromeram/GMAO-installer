...
class MachinePrediction(Base):
    ...
    recommended_actions = Column(Text, nullable=True)  # Acciones recomendadas
    ...
    created_by = relationship("User", back_populates="ai_predictions")
...
class MaintenanceOptimization(Base):
    ...
    generated_by = relationship("User", back_populates="ai_optimizations")
...
class FailurePattern(Base):
    ...
    # Relaciones
    discovered_by = relationship("User", back_populates="ai_patterns")
