...
class LicenseActivateRequest(BaseModel):
    license_key: str = Field(..., description="Clave de activación oficial de GMAO System")

class ContactInfoResponse(BaseModel):
    author: str = "GMAO System"
    contact_email: str = "fromeram@gmail.com"
    support_message: str = "Para adquirir una licencia permanente, soporte industrial o extender tu periodo de evaluación, contacta con el soporte oficial de GMAO System."
