    ...
    const handleItemSubmit = async (values) => {
        try {
            ...
            if (response.success) {
                ...
                // Marcar item como procesado y cerrar modal
            ...
            >
                {document?.type === 'albaran' && (
                    <div style={{ marginBottom: 16 }}>
                        ...
                        <p><strong>Total del Albarán:</strong> {extractedData?.totals?.total_amount || 0}€</p>
                    </div>
                )}
