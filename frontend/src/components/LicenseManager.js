      ...
      >
        <div style={{ padding: '10px 0' }}>
          ...
          <Paragraph style={{ fontSize: 13, color: '#595959' }}>
            Si dispones de una clave de activación proporcionada por el Soporte Oficial de GMAO System, ingrésala a continuación:
          </Paragraph>
          ...
          <div style={{ textAlign: 'center', color: '#8c8c8c', fontSize: 12 }}>
            ...
            Para soporte oficial o licencias permanentes, contacta con <strong>Soporte GMAO System</strong> (<a href="mailto:fromeram@gmail.com">fromeram@gmail.com</a>).
          </div>
        </div>
      </Modal>
        ...
        <div style={{ textAlign: 'center', padding: '15px 10px' }}>
          ...
          <Card style={{ background: '#fff1f0', borderColor: '#ffa39e', textAlign: 'left', marginBottom: 20 }}>
            ...
            <Text style={{ fontSize: 13, color: '#262626' }}>
              📞 <strong>Cómo obtener tu clave:</strong> Envía este ID de Servidor al <strong>Soporte Oficial de GMAO System</strong> (<a href="mailto:fromeram@gmail.com">fromeram@gmail.com</a>) para recibir tu clave de activación permanente o soporte comercial.
            </Text>
          </Card>
